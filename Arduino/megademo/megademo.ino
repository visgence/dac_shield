...
//Will also work on UNO using softSPI
...
void sample(){
    ...
    writeMCP492x(data0, 0x30,SS0,&SS0PORT);
    writeMCP492x(data1, 0x30,SS1,&SS1PORT);
}

//Method to write to the DAC
void writeMCP492x(uint16_t data, uint8_t config,uint8_t ss,volatile uint8_t* slave_port) {
